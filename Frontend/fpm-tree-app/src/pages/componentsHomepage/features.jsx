                    ...
                    <Grid item xs={12} md={6}>
                        <div>
                            ...
                            <Typography variant="body1" color="white" sx={{ mb: { xs: 2, sm: 4 } }}>
                                Designed to be powerful for professionals and accessible for beginners, here's a summary of how our platform can boost your research.
                            </Typography>
                        </div>
                        <Stack direction="column" spacing={2}>
                            ...
                            <Grid item container spacing={1}>
                                <CheckCircleRoundedIcon sx={{ color: 'white', mr: 1 }} />
                                <Typography variant="body1" color='white'>Easily control and manage your analyses visually — no coding required.</Typography>
                            </Grid>
                        </Stack>
                    </Grid>
                    <Grid item xs={12} md={6} sx={{ display: { xs: 'none', sm: 'flex' }, width: '100%' }}>
                        <Card variant="outlined" sx={{ backgroundColor:'#FFFFFF00',height: '100%', width: '100%', minHeight: 600, pointerEvents: 'none', overflow: 'hidden' }}>
                            <Carousel autoplay={{ dotDuration: true }} arrows effect="fade" autoplaySpeed={5000}>
