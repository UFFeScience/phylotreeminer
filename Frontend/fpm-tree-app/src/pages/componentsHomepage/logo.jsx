...
const Logo = ({color='#1890ff', size='40px'}) => (
    

    <svg width={size} height={size} viewBox="0 0 512 512" id="svg2793" style={{
        fillRule: 'evenodd',
        clipRule: 'evenodd',
